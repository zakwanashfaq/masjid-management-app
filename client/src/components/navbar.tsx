            ...
            <>
                ...
                <nav className="navbar py-4">
                    <div className="container-xl">
                        ...
                        <div className='fw-bold btn btn-primary d-none d-md-block' onClick={copyEmailToClipboard}>
                            Donate by interac at <a className='text-light'>{interacEmail}</a>
                        </div>
                        <div className='fw-bold btn btn-primary w-100 d-md-none' onClick={copyEmailToClipboard}>
                            Donate by interac at <a className='text-light'>{interacEmail}</a>
                        </div>
                    </div>
                </nav>
