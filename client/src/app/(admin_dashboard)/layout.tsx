            ...
            <div className="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style={{ width: "280px" }}>
                ...
                <ul className="nav nav-pills flex-column mb-auto">
                    <li className="nav-item m-1">
                        <a href="#" className="nav-link text-white d-flex align-items-center w-100" aria-current="page">
                    ...
                    <li className="nav-item m-1 d-flex">
                        <a href="#" className="nav-link text-white d-flex align-items-center active w-100">
                    ...
                    <li className="nav-item m-1 d-flex">
                        <a href="#" className="nav-link text-white d-flex align-items-center w-100">
